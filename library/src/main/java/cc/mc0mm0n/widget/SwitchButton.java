...
public class SwitchButton extends CompoundButton {
    ...
    private SwitchButtonAnimationController mSwitchButtonAnimationController;
    ...
    public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        mConf.setThumbMarginInPixel(ta.getDimensionPixelSize(R.styleable.SwitchButton_mc__sb_thumb_margin, mConf.getDefaultThumbMarginInPixel()));
        mConf.setThumbMarginInPixel(ta.getDimensionPixelSize(R.styleable.SwitchButton_mc__sb_thumb_marginTop, mConf.getThumbMarginTop()),
                ta.getDimensionPixelSize(R.styleable.SwitchButton_mc__sb_thumb_marginBottom, mConf.getThumbMarginBottom()),
                ta.getDimensionPixelSize(R.styleable.SwitchButton_mc__sb_thumb_marginLeft, mConf.getThumbMarginLeft()),
                ta.getDimensionPixelSize(R.styleable.SwitchButton_mc__sb_thumb_marginRight, mConf.getThumbMarginRight()));
        mConf.setRadius(ta.getInt(R.styleable.SwitchButton_mc__sb_radius, SwitchButtonConfiguration.Default.DEFAULT_RADIUS));

        mConf.setThumbWidthAndHeightInPixel(ta.getDimensionPixelSize(R.styleable.SwitchButton_mc__sb_thumb_width, -1), ta.getDimensionPixelSize(R.styleable.SwitchButton_mc__sb_thumb_height, -1));

        mConf.setMeasureFactor(ta.getFloat(R.styleable.SwitchButton_mc__sb_measureFactor, -1));

        mConf.setInsetBounds(ta.getDimensionPixelSize(R.styleable.SwitchButton_mc__sb_insetLeft, 0), ta.getDimensionPixelSize(R.styleable.SwitchButton_mc__sb_insetTop, 0),
                ta.getDimensionPixelSize(R.styleable.SwitchButton_mc__sb_insetRight, 0), ta.getDimensionPixelSize(R.styleable.SwitchButton_mc__sb_insetBottom, 0));

        int velocity = ta.getInteger(R.styleable.SwitchButton_mc__sb_animationVelocity, -1);
        mSwitchButtonAnimationController.setVelocity(velocity);
    ...
    private void initView() {
        mConf = SwitchButtonConfiguration.getDefault(getContext().getResources().getDisplayMetrics().density);
        mTouchSlop = ViewConfiguration.get(getContext()).getScaledTouchSlop();
        mClickTimeout = ViewConfiguration.getPressedStateDuration() + ViewConfiguration.getTapTimeout();
        mSwitchButtonAnimationController = SwitchButtonAnimationController.getDefault().init(mOnAnimateListener);
        mBounds = new Rect();
        if (SHOW_RECT) {
    ...
    private void fetchDrawableFromAttr(TypedArray ta) {
        ...
        mConf.setOffDrawable(fetchDrawable(ta, R.styleable.SwitchButton_mc__sb_offDrawable, R.styleable.SwitchButton_mc__sb_offColor, SwitchButtonConfiguration.Default.DEFAULT_OFF_COLOR));
        mConf.setOnDrawable(fetchDrawable(ta, R.styleable.SwitchButton_mc__sb_onDrawable, R.styleable.SwitchButton_mc__sb_onColor, SwitchButtonConfiguration.Default.DEFAULT_ON_COLOR));
    ...
    private Drawable fetchThumbDrawable(TypedArray ta) {
        ...
        Drawable tempDrawable = ta.getDrawable(R.styleable.SwitchButton_mc__sb_thumbDrawable);
        if (tempDrawable != null) {
            return tempDrawable;
        }

        int normalColor = ta.getColor(R.styleable.SwitchButton_mc__sb_thumbColor, SwitchButtonConfiguration.Default.DEFAULT_THUMB_COLOR);
        int pressedColor = ta.getColor(R.styleable.SwitchButton_mc__sb_thumbPressedColor, SwitchButtonConfiguration.Default.DEFAULT_THUMB_PRESSED_COLOR);
    ...
    public void setConfiguration(SwitchButtonConfiguration conf) {
        if (mConf == null) {
            mConf = SwitchButtonConfiguration.getDefault(conf.getDensity());
        }
        ...
        mSwitchButtonAnimationController.setVelocity(mConf.getVelocity());
        this.requestLayout();
        setup();
    ...
    public void slideToChecked(boolean checked) {
        ...
        mSwitchButtonAnimationController.startAnimation(from, to);
    }
    ...
    class SBAnimationListener implements SwitchButtonAnimationController.OnAnimateListener {
