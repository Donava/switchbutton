 ...
 * @since 2014-09-25
 */
class SwitchButtonAnimationController {
     ...
     * @return
     */
    static SwitchButtonAnimationController getDefault() {
        SwitchButtonAnimationController ac = new SwitchButtonAnimationController();
        return ac;
    }
     ...
     * @return
     */
    SwitchButtonAnimationController init(OnAnimateListener onAnimateListener) {
