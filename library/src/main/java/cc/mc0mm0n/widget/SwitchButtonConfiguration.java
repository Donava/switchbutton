...
public class SwitchButtonConfiguration implements Cloneable {
    ...
    public static SwitchButtonConfiguration getDefault(float density) {
        SwitchButtonConfiguration defaultSwitchButtonConfiguration = new SwitchButtonConfiguration();
        defaultSwitchButtonConfiguration.density = density;
        defaultSwitchButtonConfiguration.setThumbMarginInPixel(defaultSwitchButtonConfiguration.getDefaultThumbMarginInPixel());

        defaultSwitchButtonConfiguration.mInsetBounds = new Rect(Default.DEFAULT_INNER_BOUNDS, Default.DEFAULT_INNER_BOUNDS, Default.DEFAULT_INNER_BOUNDS, Default.DEFAULT_INNER_BOUNDS);

        return defaultSwitchButtonConfiguration;
    }
